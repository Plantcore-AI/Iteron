...
const QUALITY_INVARIANT_OVERRIDES: &[&str] = &[
    ...
    "ctx.token_estimator.encoded_bytes_image_estimator_policy_id",
    ...
    "tools.repair_evidence.receipt_prefix",
    "tools.repair_evidence.submit_repair_evidence",
    "tools.plantcore.publish_artifact",
    "tools.plantcore.request_user_input",
    "tools.schema.supported_types",
    // Fixed registry-topology policy: repo_map remains explicitly discoverable, but is not an
    // independently settable runtime quality knob.
    "tools.tool_search.on_demand_only_tools",
    "tools.tool_policy.tool_policy_slot_version",
    "tools.tool_purpose.workspace_evidence_compared_marker",
    "tools.tool_purpose.workspace_evidence_insufficient_marker",
    ...
    "cli.app_server.plantcore.max_fact_text_bytes",
    "cli.app_server.plantcore.max_portable_uint",
    ...
    "cli.iteron_workspace_hook.max_input_bytes",
    "cli.machine_contract.max_canonical_depth",
    "cli.machine_contract.max_probe_bytes",
    "cli.machine_contract.max_safe_integer",
    ...
    "cli.recording_provider.max_ca_bytes",
    ...
    "cli.tui.headless.control.max_command_id_bytes",
    "cli.tui.headless.max_recorded_commands",
    ...
    "protocol.plantcore.max_artifact_bytes",
    "protocol.plantcore.max_artifacts",
    "protocol.plantcore.max_assistant_text_bytes",
    "protocol.plantcore.max_question_prompt_bytes",
    "protocol.plantcore.max_total_artifact_bytes",
    "protocol.plantcore.max_upload_chunk_bytes",
