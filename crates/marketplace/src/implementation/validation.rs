use super::{
    IMPLEMENTATION_PROCESS_PROTOCOL_VERSION, ImplementationError, ImplementationManifest,
    MAX_IMPLEMENTATION_ARG_BYTES, MAX_IMPLEMENTATION_ARGV, MAX_IMPLEMENTATION_ARGV_BYTES,
    MAX_IMPLEMENTATION_CANCELLATION_MS, MAX_IMPLEMENTATION_DEPENDENCIES,
    MAX_IMPLEMENTATION_EVIDENCE_BYTES, MAX_IMPLEMENTATION_OBSERVATIONS,
    MAX_IMPLEMENTATION_PATH_BYTES, MAX_IMPLEMENTATION_RUNTIME_MS, valid_id,
};
...
pub(super) fn validate_manifest(
    ...
    if manifest.protocol_version != IMPLEMENTATION_PROCESS_PROTOCOL_VERSION {
