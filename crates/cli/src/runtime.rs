...
impl Agent {
    ...
    fn owned_workflow(&self, run_id: &str, stop: bool) -> crate::workflow::Collected {
    ...
    fn collected_workflow(&self, collected: crate::workflow::Collected) -> Result<String, String> {
        match collected {
