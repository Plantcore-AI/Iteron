...
pub(super) const DEFAULTS: [DefaultSpec; 85] = [
    ...
    literal_default!(integer_value!(40)), // 5 max_turns
    operator_default!("max_usd"),         // 6 max_usd
    operator_default!("max_tokens"),      // 7 max_tokens
    literal_default!(integer_value!(1_800)), // 8 max_wall_secs
    literal_default!(boolean_value!(false)), // 9 allow_code
    ...
    derived_default!("compaction_trigger"), // 13 compaction_trigger
    ...
    literal_default!(boolean_value!(false)), // 30 memory_enable
    ...
    derived_default!("max_consecutive_tool_errors"), // 34 max_consecutive_tool_errors
