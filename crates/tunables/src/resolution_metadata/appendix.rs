...
pub(super) const DEFAULTS: [DefaultSpec; 75] = [
    ...
    literal_default!(list_value!(object_value!(
        "error_class" => text_value!("transport.pre_dispatch"),
    ...
    literal_default!(integer_value!(120_000)), // 95 stream_idle_watchdog
    ...
    provider_default!("multimodal_context_tokens"), // 100
    ...
    literal_default!(object_value!(
        "scope" => enum_value!("session"),
        "initial_cwd" => text_value!("."),
        "preserve_changes" => boolean_value!(false),
    )), // 113 process_cwd_continuity
    literal_default!(object_value!(
        "reuse" => boolean_value!(false),
        "max_entries" => integer_value!(0),
        "max_bytes" => integer_value!(0),
        "blocked_names" => list_value!(),
    )), // 114 child_process_environment_reuse
    literal_default!(integer_value!(1)), // 115 effecting_tool_concurrency
    literal_default!(object_value!(
