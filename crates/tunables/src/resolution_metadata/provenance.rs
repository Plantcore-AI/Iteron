...
pub(super) const SOURCES: [SourceSpec; crate::EXPECTED_FAMILY_COUNT] = [
    ...
    source!(Builtin, Builtin, "crates/cli/src/runtime_tunables/execution_policy.rs"), // 61 direct_child_allocation
    ...
    source!(Builtin, Builtin, "crates/cli/src/runtime_tunables/execution_policy.rs"), // 65 workflow_aggregate
    source!(Builtin, Builtin, "crates/workflow/src/schema_retry.rs"), // 66 schema_retry_jitter
    ...
    source!(Catalog, Repository, "crates/workflow/src/runtime_identity.rs"), // 80 workflow_graph
    ...
    source!([(Builtin, Builtin, "crates/tools/src/process/policy.rs"), (RuntimeObservation, RuntimeObservation, "crates/tools/src/process/supervisor.rs")]), // 113 process_cwd_continuity
    source!([(Builtin, Builtin, "crates/tools/src/process/policy.rs"), (RuntimeObservation, RuntimeObservation, "crates/sandbox/src/lib.rs")]), // 114 child_process_environment_reuse
    ...
    source!(Builtin, Builtin, "crates/tools/src/memo.rs"), // 122 tool_result_cache_ttl
    ...
    source!([(Builtin, Builtin, "crates/verify/src/runtime_policy.rs"), (DerivedPolicy, Builtin, "crates/verify/src/runtime_policy.rs")]), // 125 flaky_test_detection_quarantine
    ...
    source!(RuntimeObservation, RuntimeObservation, "crates/cli/src/mcp/session.rs"), // 154 resource_prompt_plugin_capability_exposure
