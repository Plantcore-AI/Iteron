...
static FAMILIES: &[Family] = &[
    ...
    full!(23, "prompt_cache", Provider, "Enable or disable prompt-cache breakpoint emission for one built provider route.", Literal, "true", Builtin, "crates/provider/src/catalog.rs", Conditional, Conditional, OfflineSearch),
    ...
    missing!(158, "prompt_cache_ttl_breakpoint_strategy", Context, "Declare prompt-cache lifetime and breakpoint strategy when an independent control is implemented.", OperatorRequired, "operator-supplied strategy", Registry, "crates/tunables/src/families.rs", Indirect, Indirect, OfflineSearch),
