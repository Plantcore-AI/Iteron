...
| `boundedness` — Bounded execution | open | required | Open | `crates/kernel/**`<br>`crates/sched/**`<br>`crates/provider/**`<br>`crates/tools/**`<br>`crates/mcp/**`<br>`crates/sandbox/**`<br>`crates/record/**`<br>`crates/ctx/**`<br>`crates/agents/**`<br>`crates/evolve/**`<br>`crates/cli/src/block.rs`<br>`crates/cli/src/commands.rs`<br>`crates/cli/src/editor.rs`<br>`crates/cli/src/environment.rs`<br>`crates/cli/src/highlight.rs`<br>`crates/cli/src/markdown.rs`<br>`crates/cli/src/mcp.rs`<br>`crates/cli/src/output.rs`<br>`crates/cli/src/render.rs`<br>`crates/cli/src/surface.rs`<br>`crates/cli/src/theme.rs`<br>`crates/cli/src/tui.rs` |
| `provider-routing` — Provider routing and economics | open | required | Open | `crates/protocol/**`<br>`crates/provider/**`<br>`crates/sched/**`<br>`crates/obs/**`<br>`crates/ctx/**`<br>`crates/record/**`<br>`crates/cli/src/main.rs`<br>`crates/cli/src/pricing.rs`<br>`crates/cli/src/providers.rs`<br>`crates/cli/src/output.rs`<br>`crates/cli/src/tui.rs`<br>`crates/kernel/src/lib.rs`<br>`crates/kernel/src/pricing.rs` |
| `frontend-contract` — Frontend runtime contract | open | required | Open | `crates/protocol/**`<br>`crates/kernel/src/lib.rs`<br>`crates/provider/**`<br>`crates/obs/**`<br>`crates/ctx/src/compact.rs`<br>`crates/ctx/src/lib.rs`<br>`crates/cli/src/block.rs`<br>`crates/cli/src/commands.rs`<br>`crates/cli/src/environment.rs`<br>`crates/cli/src/main.rs`<br>`crates/cli/src/editor.rs`<br>`crates/cli/src/highlight.rs`<br>`crates/cli/src/markdown.rs`<br>`crates/cli/src/mcp.rs`<br>`crates/cli/src/providers.rs`<br>`crates/cli/src/output.rs`<br>`crates/cli/src/render.rs`<br>`crates/cli/src/surface.rs`<br>`crates/cli/src/theme.rs`<br>`crates/cli/src/tui.rs` |
| `cost-accounting` — Cost and budget accounting | open | required | Open | `crates/protocol/**`<br>`crates/provider/**`<br>`crates/sched/**`<br>`crates/kernel/src/lib.rs`<br>`crates/obs/**`<br>`crates/record/**`<br>`crates/ctx/src/compact.rs`<br>`crates/cli/src/main.rs`<br>`crates/cli/src/output.rs`<br>`crates/cli/src/pricing.rs`<br>`crates/cli/src/tui.rs` |
