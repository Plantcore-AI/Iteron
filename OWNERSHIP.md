...
| `cli-host` — CLI host | open | critical | Open | Open | `crates/cli/Cargo.toml`<br>`crates/cli/src/commands.rs`<br>`crates/cli/src/config/**`<br>`crates/cli/src/config.rs`<br>`crates/cli/src/environment.rs`<br>`crates/cli/src/file_input.rs`<br>`crates/cli/src/paste_input.rs`<br>`crates/cli/src/image_input.rs`<br>`crates/cli/src/image_input/**`<br>`crates/cli/src/main.rs`<br>`crates/cli/src/maintenance.rs`<br>`crates/cli/src/mcp.rs`<br>`crates/cli/src/plugin.rs`<br>`crates/cli/src/plugin_runtime.rs`<br>`crates/cli/src/pricing.rs`<br>`crates/cli/src/providers.rs`<br>`crates/cli/src/route.rs`<br>`crates/cli/src/runtime.rs`<br>`crates/cli/src/runtime/pricing.rs`<br>`crates/cli/src/runtime/strategy_runtime.rs`<br>`crates/cli/src/runtime/tool_interrupt.rs`<br>`crates/cli/src/runtime/workflow_spawner.rs`<br>`crates/cli/src/runtime/workflow_spawner/**`<br>`crates/cli/src/setup.rs`<br>`crates/cli/src/startup.rs`<br>`crates/cli/src/tunables.rs`<br>`crates/cli/src/workflow.rs`<br>`crates/cli/src/workspace_review.rs` |
