...
$IteronArchiveMemberNames = @(
    ...
    'contracts/plantcore/check-app-server-v5.py',
    ...
    'contracts/plantcore/examples/app-server-v5-command.json',
    ...
    'contracts/plantcore/examples/app-server-v5-listening.json',
