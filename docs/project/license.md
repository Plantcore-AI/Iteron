...
license. The project does not require a contributor license agreement.

The license covers the project's own source. A binary distribution must also
audit dependency licenses and include any required third-party notices. The
absence of a project `NOTICE` file does not remove obligations created by an
